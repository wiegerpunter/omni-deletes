...
public class OmniSketchBuilder {
    ...
    public static OmniSketchBuilder QFirstSampleLaterArrayRegBuffer() {
        return new OmniSketchBuilder()
                .setUseAcrossRows(true)
                .setUseNMax(true)
                .setSketchType("SampleLaterArrayRegBuffer");
    }
    ...
    public static OmniSketchBuilder QFirstSampleLaterArrayWithBufferOpt() {
        return new OmniSketchBuilder()
                .setUseAcrossRows(true)
                .setUseNMax(true)
                .setSketchType("SampleLaterArrayWithBufferOpt");
    }

    public static OmniSketchBuilder QFirstSampleLaterArrayWithBufferOptBatchDeletes() {
        return new OmniSketchBuilder()
                .setUseAcrossRows(true)
                .setUseNMax(true)
    ...
    public static OmniSketchBuilder QFirstSampleLaterArrayWithBufferPessDeleteCount() {
        return new OmniSketchBuilder()
                .setUseAcrossRows(true)
                .setUseNMax(true)
                .setSketchType("SampleLaterArrayWithBufferPessDeleteCount");
    }

    public static OmniSketchBuilder QFirstSampleLaterArrayWithBufferOnlyValid() {
        return new OmniSketchBuilder()
                .setUseAcrossRows(true)
                .setUseNMax(true)
                .setSketchType("SampleLaterArrayWithBufferOnlyValid");
    }
