...
//        }
    ...
    public Sample union(Sample other) {
        if (other instanceof DistinctSample) {
            return union((DistinctSample) other);
        } else {
            throw new RuntimeException("Cannot union DistinctSample with " + other.getClass().getName());
        }
    }


    public Sample intersect(Sample other) {
        if (other instanceof DistinctSample) {
            return intersect((DistinctSample) other);
        } else {
            throw new RuntimeException("Cannot intersect DistinctSample with " + other.getClass().getName());
        }
    }
