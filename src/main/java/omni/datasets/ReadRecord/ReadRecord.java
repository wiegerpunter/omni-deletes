...
public abstract class ReadRecord implements Externalizable {
    int id;
    ...
    public ReadRecord(int id, long[] record) {
        this.record = record;
        this.id = id;
    }

    public ReadRecord(ReadRecordSNMP r) {
        this.id = r.id;
        this.record = r.record;
        this.timestamp = r.timestamp;
    }
    public ReadRecord(ReadRecordCAIDA r) {
        this.id = r.id;
        this.record = r.record;
        this.timestamp = r.timestamp;
    }

    public ReadRecord(RecordSynth r) {
        this.id = r.id;
        this.record = r.record;
        this.timestamp = r.timestamp;
    }
