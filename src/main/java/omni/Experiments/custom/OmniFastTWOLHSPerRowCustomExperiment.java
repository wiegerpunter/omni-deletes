...
public class OmniFastTWOLHSPerRowCustomExperiment implements Experiment {
    private RunExperiments runExperiments;
    private final OmniSketchBuilder omniSketchBuilder;
    public OmniFastTWOLHSPerRowCustomExperiment() {
        this.omniSketchBuilder = OmniSketchBuilder.FastTWOLHSPerRow();
    }
