...
public class OmniVLDBS0PerRowCustomExperiment implements Experiment {
    private RunExperiments runExperiments;
    private final OmniSketchBuilder omniSketchBuilder;
    public OmniVLDBS0PerRowCustomExperiment() {
        this.omniSketchBuilder = OmniSketchBuilder.QFirstSampleLaterExactPerRow();
    }
