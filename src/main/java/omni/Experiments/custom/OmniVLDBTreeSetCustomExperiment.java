...
public class OmniVLDBTreeSetCustomExperiment implements Experiment {
    private RunExperiments runExperiments;
    private final OmniSketchBuilder omniSketchBuilder;
    public OmniVLDBTreeSetCustomExperiment() {
        this.omniSketchBuilder = OmniSketchBuilder.QFirstSampleLaterTreeSet();
    }
