...
public class OmniVLDBS0CustomExperiment implements Experiment {
    private RunExperiments runExperiments;
    private final OmniSketchBuilder omniSketchBuilder;
    public OmniVLDBS0CustomExperiment() {
        this.omniSketchBuilder = OmniSketchBuilder.QFirstSampleLaterExact();
    }
