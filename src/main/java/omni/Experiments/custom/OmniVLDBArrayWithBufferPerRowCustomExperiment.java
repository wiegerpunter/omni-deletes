...
public class OmniVLDBArrayWithBufferPerRowCustomExperiment implements Experiment {
    private RunExperiments runExperiments;
    private final OmniSketchBuilder omniSketchBuilder;
    public OmniVLDBArrayWithBufferPerRowCustomExperiment() {
        this.omniSketchBuilder = OmniSketchBuilder.QFirstSampleLaterArrayWithBufferPerRow();
    }
