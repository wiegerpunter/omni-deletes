...
public class OmniVLDBSimpleBufferNoDeleteBufferCustomExperiment implements Experiment {
    private RunExperiments runExperiments;
    private final OmniSketchBuilder omniSketchBuilder;
    public OmniVLDBSimpleBufferNoDeleteBufferCustomExperiment() {
        this.omniSketchBuilder = OmniSketchBuilder.QFirstSampleLaterSimpleBufferNoDeleteBuffer();
    }
