...
public class OmniTWOLHSExactCustomExperiment implements Experiment {
    private RunExperiments runExperiments;
    private final OmniSketchBuilder omniSketchBuilder;
    public OmniTWOLHSExactCustomExperiment() {
        this.omniSketchBuilder = OmniSketchBuilder.TWOLHSExact();
    }
