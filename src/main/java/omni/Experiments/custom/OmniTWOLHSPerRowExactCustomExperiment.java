...
public class OmniTWOLHSPerRowExactCustomExperiment implements Experiment {
    private RunExperiments runExperiments;
    private final OmniSketchBuilder omniSketchBuilder;
    public OmniTWOLHSPerRowExactCustomExperiment() {
        this.omniSketchBuilder = OmniSketchBuilder.TWOLHSPerRowExact();
    }
