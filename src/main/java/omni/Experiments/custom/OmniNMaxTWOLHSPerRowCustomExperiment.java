...
public class OmniNMaxTWOLHSPerRowCustomExperiment implements Experiment {
    private RunExperiments runExperiments;
    private final OmniSketchBuilder omniSketchBuilder;
    public OmniNMaxTWOLHSPerRowCustomExperiment() {
        this.omniSketchBuilder = OmniSketchBuilder.NMaxTWOLHSPerRow();
    }
