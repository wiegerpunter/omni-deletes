...
public class OmniVLDBArrayWithBufferPessDeleteCountCustomExperiment implements Experiment {
    private RunExperiments runExperiments;
    private final OmniSketchBuilder omniSketchBuilder;
    public OmniVLDBArrayWithBufferPessDeleteCountCustomExperiment() {
        this.omniSketchBuilder = OmniSketchBuilder.QFirstSampleLaterArrayWithBufferPessDeleteCount();
    }
