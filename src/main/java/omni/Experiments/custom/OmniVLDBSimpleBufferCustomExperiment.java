...
public class OmniVLDBSimpleBufferCustomExperiment implements Experiment {
    private RunExperiments runExperiments;
    private final OmniSketchBuilder omniSketchBuilder;
    public OmniVLDBSimpleBufferCustomExperiment() {
        this.omniSketchBuilder = OmniSketchBuilder.QFirstSampleLaterSimpleBuffer();
    }
