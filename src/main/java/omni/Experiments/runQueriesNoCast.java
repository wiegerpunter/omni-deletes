...
public class runQueriesNoCast {
    ...
    public runQueriesNoCast(SynopsisRefactor s, CleanDataset cd,
...
//            }
            writeResultsToFilePointQueryNoCast(repetition, s, d, ingestionTime, collisions, estimatedAnswersPointQuery,
